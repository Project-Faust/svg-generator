...
describe("Triangle", () => {
  it("should have correct points plotted for polygon, shape color, text content, and text color", () => {
    ...
    expect(triangle.render()).toContain('<polygon points="60, 30 180, 270 300, 30" fill="black" />');
  });
});
...
describe("Circle", () => {
  it("should have correct center point and radius, shape color, text content, and text color", () => {
    ...
    expect(circle.render()).toContain('<circle cx="150" cy="150" r="80" fill="green" />');
  });
});
...
describe("Square", () => {
  it("should have correct points plotted for polygon, shape color, text content, and text color", () => {
    ...
    expect(square.render()).toContain('<rect width="300" height="300" fill="blue" />');
  });
});
